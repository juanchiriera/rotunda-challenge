...
console.log("Welcome to the URL Parser!\nThe application will extract the URL parameters from a defined URL and a defined model.\nA brief example is shown below:\n");

// Example usage
var urlFormat = '/:version/api/:collection/:id';
var urlInstance = '/6/api/listings/3?sort=desc&limit=10';
